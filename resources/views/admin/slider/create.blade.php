                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('banner_header', '<span class="error-block">:message</span">') !!}
                        </div>
                         <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('banner_info_title', '<span class="error-block">:message</span">') !!}
                        </div>
                        ...
                        <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('banner_info1', '<span class="error-block">:message</span">') !!}
                        </div>
                        ...
                        <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('link_for_facebook', '<span class="error-block">:message</span">') !!}
                        </div>
                        <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('link_for_booking', '<span class="error-block">:message</span">') !!}
                        </div>
                        <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('link_for_tripadvisor', '<span class="error-block">:message</span">') !!}
                        </div>
                        <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('link_for_agoda', '<span class="error-block">:message</span">') !!}
                        </div>
                        <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('link_for_book_now', '<span class="error-block">:message</span">') !!}
                        </div>
                        <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('contact_number1', '<span class="error-block">:message</span">') !!}
                        </div>
                        <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('contact_number2', '<span class="error-block">:message</span">') !!}
                        </div>
                        <div class="form-group col-md-12" data-aos="">
                        ...
                        <div class="form-group col-md-12" data-aos="">
                            ...
                            {!! $errors->first('address', '<span class="error-block">:message</span">') !!}
                        </div>
