...
@section('content')
    <h1 class="page-title">
        <i class="glyphicon glyphicon-glass"></i> New Event Activity
    </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    <div class="panel-heading">
                        <h3 class="panel-title">Create New Event Activity</h3>
                    </div>
                    <form action="{{ route('voyager.gallery-event.store') }}" method="post" id="checkout-form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        <div>
