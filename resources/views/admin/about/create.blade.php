...
@section('content')
    <h1 class="page-title">
        <i class="glyphicon glyphicon-glass"></i> Update About Us
    </h1>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form action="{{ route('voyager.about.store') }}" method="post" id="checkout-form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        
                        <input type="hidden" name="image1" value="{{$about->image}}">


                        <div class="panel-body">
                        <div class="form-group col-md-12" data-aos="">
                            <label class="awesome">Title</label>
                            <input type="text" name="title" value="{{old('title', $about->title)}}" placeholder="Title" class="form-control">
                            {!! $errors->first('title', '<span class="error-block">:message</span">') !!}
                        </div>
                        <div class="form-group col-md-12" data-aos="">
                             <label class="awesome">Description</label>
                             <textarea rows="4" cols="50" name="description" class="form-control">{{$about->description}}</textarea>
                        ...
                        <div class="form-group col-md-6" data-aos="">
                            ...
                            <br>
                            <img src="{{ asset('thumbnail/'.$about->image) }}" width="270" alt=" " class="img-fluid" />
                        </div>
